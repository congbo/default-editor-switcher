...
- **D-06:** Recommended editors should appear before other system-eligible editors, carrying forward the Phase 1 ranking policy rather than introducing a new ordering model in the UI layer.
...
- **D-08:** After a global switch attempt, the menu should show inline success or failure feedback and refresh the visible current-state summary without forcing the main window to open.
