...
2. Verify the exported artifact with `./Tools/Release/verify-artifact.sh build/release/exported/DefaultEditorSwitcher.app build/release/DefaultEditorSwitcher-macOS.zip`.
